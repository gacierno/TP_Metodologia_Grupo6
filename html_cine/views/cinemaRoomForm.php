...
<?php endif; endif; ?>
    <div class="row cinemaRoom__form--container">
        ...
        <label style="display:none;">
            <input type="text"  name="cinema_id" value="<?php echo($cinemaRoom->getId()); ?>">
        </label>
        <?php endif; ?>

        <label>
            <input class="inputText" type="text" name="cinema_name" value="<?php if($iscinemaRoomSet) : echo($cinemaRoom->getName()); endif; ?>" required>
            <span class="floating-label">Nombre de la sala</span>
        </label>
        <label>
            <input class="inputText" type="text" name="cinema_capacity" value="<?php if($iscinemaRoomSet) : echo($cinemaRoom->getCapacity()); endif; ?>" required>
            <span class="floating-label">Capacidad de la sala</span>
        </label>
        <label>
            <input class="inputText" type="text"  name="cinema_ticketValue" value="<?php if($iscinemaRoomSet) : echo($cinemaRoom->getTicketValue()); endif; ?>" required>
